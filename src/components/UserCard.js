    ...
    <div className="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4 ">
      <div className="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
        ...
        <div className="p-4">
          ...
          <span className="inline-block mx-1 px-2 py-1 leading-none bg-blue-400 text-white rounded-full font-semibold tracking-wide text-md">
           {twitterHandle}
          </span>
        </div>
